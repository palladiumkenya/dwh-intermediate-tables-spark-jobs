package org.kenyahmis.intermediatelatestobs;
...
public class LoadIntermediateLatestObs {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (conn != null) {
                String query = new LoadIntermediateLatestObs().loadQuery();
                Statement statement = conn.createStatement();
                statement.setQueryTimeout(Integer.parseInt(timeout));
                statement.execute(query);
                System.out.println("Loaded intermediate latest obs assessments table");
            } else {
    ...
    private String loadQuery() {
        String query;
        final String fileName = "LoadLatestObs.sql";
        InputStream inputStream = LoadIntermediateLatestObs.class.getClassLoader().getResourceAsStream(fileName);
        if (inputStream == null) {

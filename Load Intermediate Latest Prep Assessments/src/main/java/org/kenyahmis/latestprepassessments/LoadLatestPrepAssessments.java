package org.kenyahmis.latestprepassessments;
...
public class LoadLatestPrepAssessments {
    public static void main(String[] args) {
        ...
        try {
            ...
            if (conn != null) {
                String query = new LoadLatestPrepAssessments().loadQuery();
                Statement statement = conn.createStatement();
                statement.setQueryTimeout(Integer.parseInt(timeout));
                statement.execute(query);
                System.out.println("Loaded intermediate prep assessments table");
            } else {
    ...
    private String loadQuery() {
        String query;
        final String fileName = "LoadLatestPrepAssessments.sql";
        InputStream inputStream = LoadLatestPrepAssessments.class.getClassLoader().getResourceAsStream(fileName);
        if (inputStream == null) {

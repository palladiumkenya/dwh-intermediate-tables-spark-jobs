...
public class LoadIntermediatePrepLastVisit {
    public static void main(String[] args) {
        ...
        try {
            ...
            if (conn != null) {
                String query = new LoadIntermediatePrepLastVisit().loadQuery();
                Statement statement = conn.createStatement();
                statement.setQueryTimeout(Integer.parseInt(timeout));
                statement.execute(query);
                System.out.println("Loaded intermediate prep last visit table");
            } else {
    ...
    private String loadQuery() {
        String query;
        final String fileName = "IntermediatePrepLastVisit.sql";
        InputStream inputStream = LoadIntermediatePrepLastVisit.class.getClassLoader().getResourceAsStream(fileName);
        if (inputStream == null) {

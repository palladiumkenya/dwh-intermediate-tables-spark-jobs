package org.kenyahmis.intermediateencounterhtstests;
...
public class LoadIntermediateEncounterHtsTests {
    public static void main(String[] args) {
        ...
        try {
            ...
            if (conn != null) {
                String query = new LoadIntermediateEncounterHtsTests().loadQuery();
                Statement statement = conn.createStatement();
                statement.setQueryTimeout(Integer.parseInt(timeout));
                statement.execute(query);
                System.out.println("Loaded intermediate encounter hts tests table");
            } else {
    ...
    private String loadQuery() {
        String query;
        final String fileName = "IntermediateEncounterHtsTests.sql";
        InputStream inputStream = LoadIntermediateEncounterHtsTests.class.getClassLoader().getResourceAsStream(fileName);
        if (inputStream == null) {

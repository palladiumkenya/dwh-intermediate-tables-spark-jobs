package org.kenyahmis.intermediateviralloadsintervals;
...
public class LoadIntermediateViralLoadsIntervals {
    public static void main(String[] args) {
        ...
        try {
            ...
            if (conn != null) {
                String query = new LoadIntermediateViralLoadsIntervals().loadQuery();
                Statement statement = conn.createStatement();
                statement.setQueryTimeout(Integer.parseInt(timeout));
                statement.execute(query);
                System.out.println("Loaded intermediate viral loads intervals table");
            } else {
    ...
    private String loadQuery() {
        String query;
        final String fileName = "LoadIntermediateViralLoadsIntervals.sql";
        InputStream inputStream = LoadIntermediateViralLoadsIntervals.class.getClassLoader().getResourceAsStream(fileName);
        if (inputStream == null) {
